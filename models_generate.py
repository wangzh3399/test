...
def getFields(tablename,datatype): #创建或查询时，根据表明返回field，dataype指定返回格式是list还是dic
    ...
    stockDataFieldsList = [
        ...
        ('dsum4' , models.DecimalField(max_digits=7,decimal_places=2,blank=False,null=True,verbose_name="近4日价格总和")),  #含当前条记录的收盘价
        ('dsum9' , models.DecimalField(max_digits=7,decimal_places=2,blank=False,null=True,verbose_name="近9日价格总和")),
        ('dsum19' , models.DecimalField(max_digits=7,decimal_places=2,blank=False,null=True,verbose_name="近19日价格总和")),
        ('dsum29' , models.DecimalField(max_digits=7,decimal_places=2,blank=False,null=True,verbose_name="近29日价格总和")),
        ('wsum4' , models.DecimalField(max_digits=7,decimal_places=2,blank=False,null=True,verbose_name="近4周价格总和")), #如果当前条记录为最后一天，则包含，否则截至上周最后一个交易日
        ('wsum9' , models.DecimalField(max_digits=7,decimal_places=2,blank=False,null=True,verbose_name="近9周价格总和")),
        ('wsum19' , models.DecimalField(max_digits=7,decimal_places=2,blank=False,null=True,verbose_name="近19周价格总和")),
        ('wsum29' , models.DecimalField(max_digits=7,decimal_places=2,blank=False,null=True,verbose_name="近29周价格总和")),
        ('msum4' , models.DecimalField(max_digits=7,decimal_places=2,blank=False,null=True,verbose_name="近4月价格总和")),
        ('msum9' , models.DecimalField(max_digits=7,decimal_places=2,blank=False,null=True,verbose_name="近9月价格总和")),
        ('msum19' , models.DecimalField(max_digits=7,decimal_places=2,blank=False,null=True,verbose_name="近19月价格总和")),
        ('msum29' , models.DecimalField(max_digits=7,decimal_places=2,blank=False,null=True,verbose_name="近29月价格总和")),
        ('dsum4' , models.DecimalField(max_digits=7,decimal_places=2,blank=False,null=True,verbose_name="近4日价格总和")),  #含当前条记录的收盘价
        ('dsum9' , models.DecimalField(max_digits=7,decimal_places=2,blank=False,null=True,verbose_name="近9日价格总和")),
        ('dsum19' , models.DecimalField(max_digits=7,decimal_places=2,blank=False,null=True,verbose_name="近19日价格总和")),
        ('dsum29' , models.DecimalField(max_digits=7,decimal_places=2,blank=False,null=True,verbose_name="近29日价格总和")),
